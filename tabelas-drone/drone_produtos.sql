...
CREATE TABLE `produtos` (
  ...
  CONSTRAINT `idcategorias` FOREIGN KEY (`fkcategria`) REFERENCES `categorias` (`descrição`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Para gravar os produtos e suas características.';
